...
import {create, define, setPrototypeOf} from './helpers.mjs';
...
export class Module {
  constructor(url, evaluator, imports) {
    ...
    define(this, 'context', create(null), enumerable, false);
...
// import {noop, define, bind, copy, ResolvedPromise} from './helpers.mjs';
