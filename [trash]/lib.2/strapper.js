...
export const ModuleStrapper = (() => {
	return class ModuleStrapper {
		get map() {
			if (this !== this.constructor.prototype) return setProperty(this, 'map', createObject(null));
		}
		...
		instantiate(module) {
			...
			setProperty(context, 'scope', setPrototypeOf(bindings, ModuleScope), enumerable, false);
			setProperty(context, 'meta', createObject(null), false, false);
