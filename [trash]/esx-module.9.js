...
function getModuleScope(SWITCHES) {
  ...
  class Module {
    ...
    static instantiate(module) {
      ...
      define(bindings, 'module', context, true, true);
    ...
    static async evaluate(module) {
      ...
      try {
        module.evaluator.prototype
          ? new module.evaluator(context)
          : await module.evaluator.call(context, context);
