...
export const {Node, Root, Construct, Closure, Template, Text, Token} = (() => {
	...
	{
		for (const Node of [Token, Text, Literal, Comment, Parent]) {
			Object.setPrototypeOf(Node.prototype, null);
		}
		const descriptors = Object.getOwnPropertyDescriptors(Parent.prototype);
		delete descriptors.constructor;
		for (const Parent of [Root, Closure, Template, Construct]) {
			Object.setPrototypeOf(Object.defineProperties(Parent.prototype, descriptors), null);
		}
